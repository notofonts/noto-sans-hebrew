...
### Could you name Noto X as Noto Y?

Our policy is to name Noto fonts based on the nomenclature used by Unicode. If the Unicode changes the script name from X to Y we will also do it.
